...
const SITE_URL    = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://www.steadyloadmoving.com';
const BRAND_NAME  = process.env.NEXT_PUBLIC_BRAND_NAME ?? 'SteadyLoad Moving';
    ...
    <tr>
      <td align="center" style="padding:40px 16px;">
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0"
          ...
          <!-- Accent bar -->
          <tr>
            <td style="height:4px;background:linear-gradient(90deg,#16def9 0%,#2563eb 100%);font-size:0;line-height:0;">&nbsp;</td>
          </tr>
