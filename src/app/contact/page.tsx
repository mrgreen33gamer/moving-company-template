...
// SteadyLoad Moving — Contact Page (unique build, not just a form import)
...
const SERVICES = [
  ...
  'Loading & Unloading', 'Office Moving', 'Storage Moves',
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 860-6060. We answer during business hours and monitor after-hours messages for urgent move-day issues across Central Texas.",
  },
  {
    question: 'How quickly can you schedule a move?',
    answer: "Many local moves book within 1–2 weeks. Peak summer weekends fill earlier. Mid-week openings often appear sooner — call for current availability.",
  },
  {
    question: 'Is the quote free?',
    answer: 'Yes. Inventory review and written quotes are free. You approve pricing before load day — no pressure.',
  },
  {
    question: 'Do you handle office and commercial moves?',
    answer: 'Yes — weekend and after-hours office moves, plus storage transfers and multi-unit property work.',
  },
  {
    question: 'What areas do you serve?',
    answer: 'Waco, Hewitt, Woodway, McGregor, China Spring, Bellmead, Temple, Killeen, and most of Central Texas within about 60 miles of Waco.',
  },
  {
    question: 'Are you licensed and insured?',
    answer: "Yes. SteadyLoad Moving is TXDOT-registered · Fully Bonded & Insured, with damage protection options available.",
  },
];
  ...
  return (
    <main className={styles.page}>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@steadyloadmoving.com',
                  href:      'mailto:hello@steadyloadmoving.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '3500 Franklin Ave, Waco TX 76710',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose SteadyLoad Moving</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '1-year parts & labor warranty on every repair',
                'TXDOT-Registered Crews only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A licensed SteadyLoad Moving Moving Specialist will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12548606060">(254) 860-6060</a>.
                  </p>
                ...
                <motion.div key="form" className={styles.formCard}
                  ...
                  <div className={styles.formCardHeader}>
                    ...
                    <div>
                      <h2 className={styles.formTitle}>Request Service or a Free Quote</h2>
      ...
      <CTABanner
        ...
        subline="Call (254) 860-6060 — we answer 7 days a week, evenings included. Emergency service available across Central Texas."
        primaryText="Call (254) 860-6060"
        primaryLink="tel:+12548606060"
        secondaryText="Send a Text"
        secondaryLink="sms:+12548606060"
      />
