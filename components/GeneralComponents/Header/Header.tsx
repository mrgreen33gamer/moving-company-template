...
const logoName = 'SteadyLoad Moving';
const logoTagline = 'Local | Long-Distance | Packing';
const navLinks = [
  { href: '/', label: 'Home' },
...
const phoneDisplay = '(254) 860-6060';
const phoneHref = 'tel:+12548606060';
const ctaLabel = 'Free Quote';
