 ...
 * → "Hot Rocks Logo Design — SteadyLoad Moving Portfolio"
 */
function fileToAlt(filename: string): string {
  ...
  return `${words} — SteadyLoad Moving Portfolio`;
}
        ...
        >
          ...
          <div className={styles.modalContent}>
            ...
            {project.offline ? (
              ...
              <a href={project.liveUrl} target="_blank" rel="noloading help noreferrer" className={styles.modalCta}>
                Visit Live Site
