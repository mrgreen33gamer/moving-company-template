...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'SteadyLoad Moving',
  address       = 'Waco, TX 76710',
  phone         = '(254) 860-6060',
  email         = 'service@steadyloadmoving.com',
  googleMapsUrl = 'https://maps.google.com/?q=SteadyLoad+Door+Pros+moving+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed Moving Specialists.
          </p>
        </div>
