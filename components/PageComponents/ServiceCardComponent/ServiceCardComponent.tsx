...
export default function ServiceCardComponent({
  cards,
  heading    = 'Everything Your Moving Needs',
  subheading = 'From local moves to long-distance, packing, office, and storage — SteadyLoad handles it all — on time, on price.',
