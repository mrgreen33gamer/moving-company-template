...
const TRUST_CHIPS = [
  ...
  { icon: faShieldHalved, text: 'TXDOT · Insured' },
  { icon: faStar,         text: '4.9★ · 2,200+ reviews' },
];
    ...
    <section className={styles.root}>
      ...
      <div className={styles.inner}>
        ...
        <motion.div className={styles.header}
          ...
          <span className={styles.eyebrow}>Free Quote · No Obligation</span>
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A licensed SteadyLoad Moving crew member will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12548606060"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 860-6060', section: 'ContactForm-V1' })}>
                          Call (254) 860-6060
                        </a>
                      </span>
                    </div>
